  ...
  return (
    <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xs dark:border-slate-800 dark:bg-slate-900">
      <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800">
        <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">Desempenho por Categoria</h3>
            ...
            <div className="flex items-center gap-6 sm:w-1/2">
              <div className="flex-1 space-y-1.5">
                <div className="flex items-center justify-between text-xs text-slate-600 dark:text-slate-400">
                  ...
                  <span className="font-bold text-indigo-700 dark:text-indigo-400">{`${cat.progressRate}%`}</span>
                </div>
              ...
              <div className="text-right shrink-0">
                <span className="block text-xs text-slate-500 dark:text-slate-400">Conclusão</span>
                <span className="text-sm font-bold text-slate-900 dark:text-slate-100">{`${cat.completionRate}%`}</span>
              </div>
            </div>
          </div>
        ))}
