...
function GoalFormContent({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="goal-category" className="block text-xs font-semibold text-slate-700 dark:text-slate-300">
      ...
      <div>
        <label htmlFor="goal-title" className="block text-xs font-semibold text-slate-700 dark:text-slate-300">
      ...
      <div>
        <label htmlFor="goal-desc" className="block text-xs font-semibold text-slate-700 dark:text-slate-300">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          <label htmlFor="goal-type" className="block text-xs font-semibold text-slate-700 dark:text-slate-300">
          ...
          <select
            ...
            className={`mt-1 block w-full rounded-lg border border-slate-300 px-3 py-2 text-sm shadow-xs focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 dark:border-slate-700 dark:text-slate-100 ${
              isEditing ? 'cursor-not-allowed bg-slate-100 text-slate-500 dark:bg-slate-800/60 dark:text-slate-500' : 'bg-white dark:bg-slate-800'
            }`}
          >
        ...
        <div>
          <label htmlFor="goal-priority" className="block text-xs font-semibold text-slate-700 dark:text-slate-300">
            Prioridade
          </label>
          <select
            id="goal-priority"
      ...
      {type === 'QUANTITY' && (
        <div>
          <label htmlFor="goal-target" className="block text-xs font-semibold text-slate-700 dark:text-slate-300">
